...
export const SHOP_ITEMS: Item[] = [
  ...
  { id: 'i3', name: '酷酷墨镜', price: 50, type: 'head_accessory', image: '🕶️' },
  { id: 'i4', name: '小红帽', price: 50, type: 'head_accessory', image: '👒' },
  { id: 'i5', name: '蝴蝶结', price: 80, type: 'clothes', image: '🎀' },
  { id: 'i6', name: '魔法棒', price: 80, type: 'hand_accessory', image: '🪄' },
  { id: 'i7', name: '甜甜圈', price: 25, type: 'food', image: '🍩', effect: { hunger: 10 } },
  { id: 'i8', name: '新鲜牛奶', price: 10, type: 'food', image: '🥛', effect: { hunger: 10 } },
  { id: 'i9', name: '皇冠', price: 100, type: 'head_accessory', image: '👑' },
  { id: 'i10', name: '披风', price: 200, type: 'clothes', image: '🧥' },
  { id: 'i11', name: '小气球', price: 50, type: 'hand_accessory', image: '🎈' },
