            ...
            <>
              ...
              >
                {leftHandItems.map((item, index) => (
                  <span 
                    key={item?.id || index}
                    className="absolute bottom-[35%] left-[1%] -translate-x-1/2 text-6xl z-30 filter drop-shadow-[0_0_10px_rgba(255,255,255,0.4)] select-none pointer-events-none"
              ...
              >
                {rightHandItems.map((item, index) => (
                  <span 
                    key={item?.id || index}
                    className="absolute bottom-[65%] left-1/2 -translate-x-1/2 text-6xl z-30 filter drop-shadow-[0_0_10px_rgba(255,255,255,0.4)] select-none pointer-events-none"
